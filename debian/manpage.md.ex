...
btop - program to do something

# SYNOPSIS

**btop** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
...
:   The system-wide configuration file to control the behaviour of
    btop. See **foo.conf**(5) for further details.
...
**btop** provides some return codes, that can be used in scripts:
...
Copyright © 2007 Otto Kekäläinen
